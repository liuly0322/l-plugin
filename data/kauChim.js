...
您一定会继续交好运的哦!`,
    ...
    name: '中吉·天工突每',
    dsc: `天上有云飘过的日子，天气令人十分舒畅。
工作非常顺利，连午睡时也会想到好点子。
突然发现，与老朋友还有其他的共同话题…
——每一天，每一天都要积极开朗地度过——`,
    item: `今天的幸运物是：色泽艳丽的「堇瓜」。
人们常说表里如一是美德，
...
可以整顿一番心情，清理一番家装，
说不定能发现意外之财。`,
    item: `今天的幸运物是：节节高升的「竹笋」。
竹笋拥有着无限的潜力，
没有人知道一颗竹笋，到底能长成多高的竹子。
看着竹笋，会让人不由自主期待起未来吧。`
  }, {
    name: '末吉·气早会偶',
    dsc: `气压稍微有点低，是会令人想到遥远的过去的日子。
早已过往的年轻岁月，与再没联系过的故友的回忆，
会让人感到一丝平淡的怀念，又稍微有一点点感伤。
——偶尔怀念过去也很好。放松心情面对未来吧——`,
    item: `今天的幸运物是：清新怡人的「薄荷」。
只要有草木生长的空间，就一定有薄荷。
这么看来，薄荷是世界上最强韧的生灵。
据说连蒙德的雪山上也长着薄荷呢。`
  }, {
    name: '末吉·空不但宜',
    dsc: `空中的云层偏低，并且仍有堆积之势，
不知何时雷雨会骤然从头顶倾盆而下。
但是等雷雨过后，还会有彩虹在等着。
宜循于旧，守于静，若妄为则难成之。`,
    item: `今天的幸运物是：树上掉落的「松果」。
并不是所有的松果都能长成高大的松树，
成长需要适宜的环境，更需要一点运气。
所以不用给自己过多压力，耐心等待彩虹吧。`
  }, {
...
现下不如趁此机会磨炼自我，等待拨云见皎月。`,
    item: `今天的幸运物是：暗中发亮的「发光髓」。
发光髓努力地发出微弱的光芒。
虽然比不过其他光源，但看清前路也够用了。`
  }, {
    name: '末吉·平适吃要',
    dsc: `平稳安详的一天。没有什么令人难过的事情会发生。
适合和久未联系的朋友聊聊过去的事情，一同欢笑。
吃东西的时候会尝到很久以前体验过的过去的味道。
——要珍惜身边的人与事——`,
    item: `今天的幸运物是：酥酥麻麻的「电气水晶」。
电气水晶蕴含着无限的能量。
如果能够好好导引这股能量，说不定就能成就什么事业。`
  }, {
    name: '末吉·晴虽留可',
    dsc: `晴朗的天空突然刮过一阵风，它预示着什么？
虽然有在原地打转的感觉，但这只是暂时的。
留心出现在身边的人，虽然都是熟悉的面容。
可你的命运，却会因为他们的存在悄悄改变…`,
    item: `今天的幸运物是：来自遥远异国的蒲公英。
随风而起的种子，是你最好的象征。
飞翔吧，漂泊吧，跨越大海，行至远方。
但总有一天，你将不再漂泊。
总有一天，你一定能成为你希望的模样。`
...
如果身体有不适，一定要注意休息。
在做出决定之前，一定要再三思考。`,
    item: `今天的幸运物是：冰凉冰凉的「冰雾花」。
冰雾花散发着「生人勿进」的寒气。
但有时冰冷的气质，也能让人的心情与头脑冷静下来。
据此采取正确的判断，明智地行动。`
  }, {
    name: '凶·隐应明难',
    dsc: `隐约感觉会下雨的一天。可能会遇到不顺心的事情。
应该的褒奖迟迟没有到来，服务生也可能会上错菜。
明明没什么大不了的事，却总感觉有些心烦的日子。
——难免有这样的日子——`,
    item: `今天的幸运物是：随波摇曳的「海草」。
海草是相当温柔而坚强的植物，
即使在苦涩的海水中，也不愿改变自己。
即使在逆境中，也不要放弃温柔的心灵。`
  }, {
    name: '大凶·内很虽若',
    dsc: `内心空落落的一天。可能会陷入深深的无力感之中。
很多事情都无法理清头绪，过于钻牛角尖则易生病。
虽然一切皆陷于低潮谷底中，但也不必因此而气馁。
若能撑过一时困境，他日必另有一番作为。`,
    item: `今天的幸运物是：弯弯曲曲的「蜥蜴尾巴」
蜥蜴遇到潜在的危险时，大多数会断尾求生。
若是遇到无法整理的情绪，那么该断则断吧。`
  }
]
